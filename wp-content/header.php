...
<![endif]-->
  ...
  <link rel="home" title="Beranda" href="<?php echo get_option('home'); ?>/" />
...
<body <?php body_class(); ?>>
  ...
  <div id="header" class="header">
    <div class="doc">
      ...
      <ul class="nav">
<?php
print ('<li class="'.(is_home()?'current_page_item':'').'"><a href="'.get_option('home').'/">Beranda</a></li>');
?>
