	...
	<?php if (have_posts()) : ?>
		...
		<?php while (have_posts()) : the_post(); ?>
			...
			<div <?php post_class('article') ?> id="post-<?php the_ID(); ?>">
				...
				<?php comments_popup_link(__('Tidak ada komentar &#187;', 'kubrick'), __('1 komentar &#187;', 'kubrick'), __('% komentar &#187;', 'kubrick'), '', __('Komentar ditutup', 'kubrick') ); ?></div>
				...
				<ul class="meta taxonomy box">
					...
					<li><?php printf(__('Dikirimkan di %s', 'kubrick'), get_the_category_list(', ')); ?></li>
