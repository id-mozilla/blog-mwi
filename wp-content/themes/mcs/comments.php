...
<?php if ( have_comments() ) : ?>
	<h2 id="comments"><?php comments_number(__('Tidak ada komentar', 'kubrick'), __('1 komentar', 'kubrick'), __('% komentar', 'kubrick'));?> <?php printf(__('untuk &#8220;%s&#8221;', 'kubrick'), the_title('', '', false)); ?></h2>
